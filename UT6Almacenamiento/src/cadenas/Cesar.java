...
public class Cesar {
	...
	public static String pedirFrase() {
		...
		System.out
				.print("Introduzca la frase que desea codificar/decodificar: ");
	...
	public static int pedirDesplazamiento() {
		...
		do {
			...
			System.out
					.print("Introduzca desplazamiento para codificación/decodificación (número entero positivo): ");
			try {
	...
	public static char codCesar(char letra, int desplazamiento) {
		...
		if (Character.isLowerCase(letra))
			return Character.toLowerCase(ABECEDARIO.charAt((ABECEDARIO
					.indexOf(Character.toUpperCase(letra)) + desplazamiento)
					% ABECEDARIO.length()));
		else
			return ABECEDARIO
					.charAt((ABECEDARIO.indexOf(letra) + desplazamiento)
							% ABECEDARIO.length());
	}
	...
	/**
	 * METODO decodificarFraseCesar (decodifica una frase con la codificación
	 * César)
	 */
